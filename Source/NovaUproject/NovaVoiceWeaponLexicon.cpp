...
namespace
{
	...
	static const TCHAR* G_SpearContains[] = {TEXT("창"), TEXT("spear"), TEXT("lance"), TEXT("랜스"), TEXT("스피어"), nullptr};
	static const TCHAR* G_SpearExact[] = {
		TEXT("창"), TEXT("창술"), TEXT("차"), TEXT("창이"), TEXT("spear"), TEXT("lance"), nullptr
	};
...
ENovaVoiceCommand FNovaVoiceWeaponLexicon::MatchDirectHangul(const FString& HangulOnly)
{
	...
	if (HangulOnly == TEXT("창") || HangulOnly == TEXT("차") || HangulOnly == TEXT("창술"))
	{
	...
	float WeaponMinConfidence)
{
	...
	if (Command == ENovaVoiceCommand::Spear && IsSpearHangul(HangulOnly))
	{
		return 0.05f;
	}
	...
	float& OutConfidence)
{
	...
	{
		if (PrimaryDirect == ENovaVoiceCommand::Spear && PrimaryHangul == TEXT("차"))
		{
